            ...
            <div v-if="paginaAtual == 'espera'">
              ...
              <div v-if="ShowForm">
                ...
                <div class="row" v-if="typeof responseGoogleBooks !== 'undefined'">
                  ...
                  <div class="col-xl-2 col-md-6 mb-4" v-for="book, index of responseGoogleBooks.slice(0, 10)" v-if="Object.keys(book.volumeInfo).includes('imageLinks') && Object.keys(book.volumeInfo).includes('authors')">
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div><img :src="livro.capa" alt="" title="" class="capa-livro"></div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{livro.paginas}} páginas</div>
                      </div>
                    </div>
